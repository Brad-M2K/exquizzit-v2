...
export default function SelectTopicButton() {
    ...
    return (
        <button
            ...
            className={clsx("text-[#00ffee] hover:bg-purple-900 hover:scale-105 transition rounded-xl px-4 py-2 text-white font-bold shadow-md flex justify-center items-center border border-white/30 lg:border-transparent lg:text-2xl cursor-pointer",
